    ...
    <head>
      ...
      <meta charset="UTF-8">
       <title>Quickdrop - Trading W.L.L</title>
        ...
        <meta name="robots" content="index, QuickDrop Trading W.L.L. & Construction Company,Doha Qatar"/>
        <meta name="keywords" content="QuickDrop Trading W.L.L"/>
...
<link rel="manifest" href="/site.webmanifest">
    ...
    <body>
        ...
        <div id="main">
               ...
               <a href="#" class="header-logo ajax"><img src="images/logo.png" alt=""></a>
                ...
                <div class="header-contacts">
                    <ul>
                        ...
                        <li><span> Write </span> <a href="mailto:info@quickdropwll.com">info@quickdropwll.com</a></li>
                    </ul>
                </div>
                <!-- navigation  end -->            
            </header>
            ...
            <div id="wrapper">
                <!-- content-holder  -->	
                <div class="content-holder" data-pagetitle="www.quickdropwll.com">
                    <!-- nav-holder-->
                        ...
                        <div class="hero-title fl-wrap first-tile_load">
                            <div class="container">
                                <div class="section-title fl-wrap">
                                    <!-- <h2>Quick<span>Drop</span>   <br>Trading & Contracting</h2> -->
                                    <h2>Quick<span>Drop</span>  </h2>
                                    <div class="heading-container101">
                                      <h1 class="heading2">Trading & Contracting</h1>
                                         <h1 class="heading2">Biomedical Solution</h1>
                                          <h1 class="heading2">IT Solution</h1>
                                 </div>
                                    <p> </p>
                                    <div class="section-title_category"><a href="#">Quickdrop</a> <a href="#">Trading</a> </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms_item2 fl-wrap kenburns ">
                                                    <div class="bg" data-bg="images/bg/N106.jpg"></div>
                                                    <div class="overlay"></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->                                                 
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms_item3 fl-wrap">
                                                    <div class="bg" data-bg="images/bg/N103.webp"></div>
                                                    <div class="overlay"></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->
                                            ...
                                            <div class="swiper-slide">
                                                <div class="ms_item3 fl-wrap">
                                                    <div class="bg" data-bg="images/bg/N104.jpg"></div>
                                                    <div class="overlay"></div>
                                                </div>
                                            </div>
                                            <!--ms_item end-->                                                 
